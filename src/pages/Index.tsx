          ...
          <div className="p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <CodeverseButton
                ...
                className={`w-full h-14 relative overflow-hidden group border-0 rounded-lg shadow-[0_0_20px_rgba(163,230,53,0.25)] ${
                  !teamName.trim() ? "opacity-60 grayscale cursor-not-allowed" : "hover:shadow-[0_0_35px_rgba(163,230,53,0.5)]"
                }`}
