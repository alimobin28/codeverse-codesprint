    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        <motion.div
          ...
          className="text-xl font-mono text-codeverse-warning"
        >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div>
              <span className="text-sm text-muted-foreground font-mono">ROUND 2</span>
              <h1 className="font-display text-3xl font-bold text-codeverse-warning">
                Failing Time Flow
              </h1>
            </div>
              ...
              <motion.div
                ...
                className={`text-right p-4 rounded-lg border ${
                  timeRemaining < 30
                    ...
                    : "border-codeverse-warning/50 bg-codeverse-warning/5"
                }`}
              >
                ...
                <p
                  className={`text-4xl font-display font-bold ${
                    timeRemaining < 30 ? "text-destructive" : "text-codeverse-warning"
                  }`}
                >
        ...
        {!hasStarted ? (
          ...
          >
            <CodeverseCard variant="elevated" className="max-w-md mx-auto">
              <CodeverseCardHeader>
                <CodeverseCardTitle className="text-codeverse-warning">
                  Ready to Begin?
                </CodeverseCardTitle>
              </CodeverseCardHeader>
              <CodeverseCardContent>
          ...
          >
            <CodeverseCard variant="elevated" className="max-w-md mx-auto">
              <CodeverseCardHeader>
                <CodeverseCardTitle className="text-codeverse-terminal">
                  Round 2 Complete
                </CodeverseCardTitle>
              </CodeverseCardHeader>
              <CodeverseCardContent>
                <p className="text-muted-foreground font-mono mb-6">
                  You have navigated the failing time flow. All problems have been attempted.
                </p>
              ...
              <CodeverseCardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-lg bg-codeverse-warning/20 flex items-center justify-center">
                      <span className="font-display font-bold text-xl text-codeverse-warning">
              ...
              <div
                ...
                className={`w-3 h-3 rounded-full transition-all ${
                  index === currentProblemIndex
                    ? "bg-codeverse-warning scale-125"
